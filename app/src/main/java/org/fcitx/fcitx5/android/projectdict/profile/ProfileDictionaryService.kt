...
object ProfileDictionaryCatalog {
    val entries: List<ProfileCatalogEntry> = listOf(
        ...
        ProfileCatalogEntry(profileId = "product.content-community-ops", defaultEnabled = false),
        ProfileCatalogEntry(profileId = "product.seo-sem-aso", defaultEnabled = false),
        ...
        ProfileCatalogEntry(profileId = "compliance.infosec", defaultEnabled = false),
        ProfileCatalogEntry(profileId = "compliance.cn-regulation", defaultEnabled = false)
    )
